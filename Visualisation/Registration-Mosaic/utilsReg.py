...
def getTransparentImg(src, imageName, writepath):
  """
...
def do_global_registration(fullImgPaths, middle_num, seq_length, seq_start, padding_size, mask_im, H_global, writepath):
    for i in range((seq_length)):
        ...
        getTransparentImg(src, imageName, writepath)
